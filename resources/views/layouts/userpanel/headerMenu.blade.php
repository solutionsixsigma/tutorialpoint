      <header class="header white-bg">
            ...
            <!--logo start-->
            <a href="/" class="logo">{{ config('app.Name', 'Tutorial')}}<span>{{ config('app.Name', 'Point')}}</span></a>
            <!--logo end-->
                ...
                <ul class="nav top-menu">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{ asset('vendors/img/avatar-mini.jpg')}}')}}"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{ asset('vendors/img/avatar-mini2.jpg')}}"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{ asset('vendors/img/avatar-mini3.jpg')}}"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{ asset('vendors/img/avatar-mini4.jpg')}}"></span>
                                    <span class="subject">
            ...
            <div class="top-nav ">
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <img alt="" src="{{ asset('vendors/img/avatar1_small.jpg')}}">
