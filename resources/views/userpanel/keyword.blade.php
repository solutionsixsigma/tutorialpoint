...
@section('content')
 ...
 <div class="row">
  ...
  <tbody>
    ...
    <tr class="gradeX" id="sid{{$keyword->id}}">
        <td><input type="checkbox" name="ids" class="checkBoxClass" value="{{$keyword->id}}"></td>
        <td>{{ $no++ }}</td>
        <td>{{ $keyword->keyword_name }}</td>
        <td>{{ $keyword->subject_id }}</td>
        <td>
             <button class="btn btn-success btn-sm" onclick="viewBoard({{$keyword->id}})"><i class="fa fa-check"></i></button>
             <button class="btn btn-primary btn-sm" onclick="editBoard({{$keyword->id}})"><i class="fa fa-pencil"></i></button>
             <button class="btn btn-danger btn-sm" onclick="deleteBoard({{$keyword->id}})" ><i class="fa fa-trash-o "></i></button>
          </td>
    </tr>
    @endforeach
