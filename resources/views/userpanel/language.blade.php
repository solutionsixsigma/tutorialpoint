...
{{ session()->put('page', 'Keyword') }}
 ...
 <div class="row">
  ...
  <tbody>
    ...
    <tr class="gradeX" id="sid{{$language->id}}">
        <td><input type="checkbox" name="ids" class="checkBoxClass" value="{{$language->id}}"></td>
        <td>{{ $no++ }}</td>
        <td>{{ $language->language_name }}</td>
        <td>
             <button class="btn btn-success btn-sm" onclick="viewBoard({{$language->id}})"><i class="fa fa-check"></i></button>
             <button class="btn btn-primary btn-sm" onclick="editBoard({{$language->id}})"><i class="fa fa-pencil"></i></button>
             <button class="btn btn-danger btn-sm" onclick="deleteBoard({{$language->id}})" ><i class="fa fa-trash-o "></i></button>
          </td>
    </tr>
    @endforeach
  </tbody>
