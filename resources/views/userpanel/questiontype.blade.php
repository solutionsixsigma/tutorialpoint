...
{{ session()->put('page', 'Keyword') }}
 ...
 <div class="row">
  ...
  <tbody>
    ...
    <tr class="gradeX" id="sid{{$questiontype->id}}">
        <td><input type="checkbox" name="ids" class="checkBoxClass" value="{{$questiontype->id}}"></td>
        <td>{{ $no++ }}</td>
        <td>{{ $questiontype->typeofquestion_name }}</td>
        <td>
             <button class="btn btn-success btn-sm" onclick="viewBoard({{$questiontype->id}})"><i class="fa fa-check"></i></button>
             <button class="btn btn-primary btn-sm" onclick="editBoard({{$questiontype->id}})"><i class="fa fa-pencil"></i></button>
             <button class="btn btn-danger btn-sm" onclick="deleteBoard({{$questiontype->id}})" ><i class="fa fa-trash-o "></i></button>
          </td>
    </tr>
    @endforeach
