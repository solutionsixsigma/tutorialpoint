 ...
 <div class="row">
  ...
  <tbody>
    ...
    <tr class="gradeX" id="sid{{$board->id}}">
        <td><input type="checkbox" name="ids" class="checkBoxClass" value="{{$subtopic->id}}"></td>
        <td>{{ $no++ }}</td>
        <td>{{ $subtopic->board_name }}</td>
        <td>{{ $subtopic->board_type }}</td>
        <td>{{ $subtopic->board_nick }}</td>
        <td>
             <button class="btn btn-success btn-sm" onclick="viewBoard({{$subtopic->id}})"><i class="fa fa-check"></i></button>
             <button class="btn btn-primary btn-sm" onclick="editBoard({{$subtopic->id}})"><i class="fa fa-pencil"></i></button>
             <button class="btn btn-danger btn-sm" onclick="deleteBoard({{$subtopic->id}})" ><i class="fa fa-trash-o "></i></button>
          </td>
    </tr>
    @endforeach
  </tbody>
                      ...
                      <div class="modal-dialog">
                          <div class="modal-content">
                              <div class="modal-header">
                                  <h5 class="modal-title">Add Sub Topics</h5>
